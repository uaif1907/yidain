<template>
    <div class="list-box">
                ...
                <el-col :span="6" style="display: flex">
                    ...
                    <el-col :span="10">
                        ...
                        <el-breadcrumb separator="/" class="size-box">
                            ...
                            <el-breadcrumb-item :to="{ name:'toilet'}">卫生间</el-breadcrumb-item>
                        </el-breadcrumb>
                        <div class="tu-box">
                            <i class="el-icon-arrow-up"></i>
                            <i class="el-icon-arrow-down"></i>
                ...
                <el-form ref="form" :model="form" label-width="80px" class="form-box">
                    <el-col :span="10" class="input-box">
                        <el-form-item label="排序">
                            <el-select v-model="form.region" placeholder="请选择排序方式" style="border-radius: 20px;float: left;">
                                <el-option label="按销量排序" value="sales"></el-option>
                    ...
                    <el-col :span="10" class="input-box">
                        <el-form-item label="价格">
                            <el-col :span="11">
                                <el-input v-model="form.pricel" placeholder="请输入价格" style="width: 134px"></el-input>
                            </el-col>
                            <el-col class="line" :span="2">-</el-col>
                            <el-col :span="11">
                                <el-input v-model="form.pricer" placeholder="请输入价格" style="width: 134px"></el-input>
                            </el-col>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        ...
                        <el-col style="display: flex;justify-content: space-around;margin-left: 50px;" :span="6">
                            <div>卫生间：</div>
                            <div @click="basins()" style="cursor: pointer">洗脸池</div>|
                            <div @click="stopcocks()" style="cursor: pointer">水龙头</div>|
                            <div @click="showers()" style="cursor: pointer">花洒</div>|
                            <div @click="mirrors()" style="cursor: pointer">镜柜</div>
                        </el-col>
                        ...
                        <el-col :span="24" style="display: flex; margin-top: 10px;flex-wrap: wrap;justify-content: space-around">
                            <transition name="el-fade-in-linear">
                                <el-col :span="10" v-show="basin" class="transition-box">
                                    <el-form-item label="分类" prop="fl">
                                        <el-radio-group v-model="fl" style="margin-bottom: 20px;" class="button-box">
                                            <el-radio-button :label="true">独立式</el-radio-button>
                                            <el-radio-button :label="false">双缸水槽</el-radio-button>
                                        </el-radio-group>
                                    </el-form-item>
                                </el-col>
                            </transition>
                            <transition name="el-fade-in-linear">
                                <el-col :span="10" v-show="basin" class="transition-box">
                                    <el-form-item label="材质" prop="cz">
                                        <el-radio-group v-model="cz" style="margin-bottom: 20px;" class="button-box">
                                            <el-radio-button :label="true">钢化玻璃</el-radio-button>
                                            <el-radio-button :label="false">陶瓷</el-radio-button>
                                            <el-radio-button>白云石</el-radio-button>
                                        </el-radio-group>
                                    </el-form-item>
                                </el-col>
                            </transition>
                        ...
                        <el-col :span="24" style="display: flex; flex-wrap: wrap;justify-content: space-around">
                            <transition name="el-fade-in-linear">
                                <el-col :span="10" v-show="stopcock" class="transition-box">
                                    <el-form-item label="材质" prop="caiz">
                                        <el-radio-group v-model="caiz" style="margin-bottom: 20px;" class="button-box">
                                            <el-radio-button :label="true">镀铬黄铜</el-radio-button>
                                            <el-radio-button :label="false">不锈钢</el-radio-button>
                                        </el-radio-group>
                                    </el-form-item>
                                </el-col>
                            </transition>
                            <transition name="el-fade-in-linear">
                                <el-col :span="10" v-show="stopcock" class="">
                                    <el-form-item label="功能" prop="gn">
                                        <el-radio-group v-model="gn" style="margin-bottom: 20px;" class="button-box">
                                            <el-radio-button :label="true">带过滤器</el-radio-button>
                                            <el-radio-button :label="false">冷水启动</el-radio-button>
                                            <el-radio-button>压力补偿</el-radio-button>
                                        </el-radio-group>
                                    </el-form-item>
                                </el-col>
                            </transition>
                        ...
                        <el-col :span="24" style="display: flex; flex-wrap: wrap;justify-content: space-around">
                            <transition name="el-fade-in-linear">
                                <el-col :span="10" v-show="Shower" class="transition-box">
                                    <el-form-item label="模式" prop="ms">
                                        <el-radio-group v-model="ms" style="margin-bottom: 20px;" class="button-box">
                                            <el-radio-button :label="true">单喷模式</el-radio-button>
                                            <el-radio-button :label="false">网喷模式</el-radio-button>
                                            <el-radio-button>全喷模式</el-radio-button>
                                        </el-radio-group>
                                    </el-form-item>
                                </el-col>
                            </transition>
                            <transition name="el-fade-in-linear">
                                <el-col :span="10" v-show="Shower" class="tie-box">
                                    <el-form-item label="材质" prop="caizhi">
                                        <el-radio-group v-model="caizhi" style="margin-bottom: 20px" class="button-box">
                                            <el-radio-button :label="true">镀铬</el-radio-button>
                                            <el-radio-button :label="false">不锈钢</el-radio-button>
                                            <el-radio-button>塑胶</el-radio-button>
                                        </el-radio-group>
                                    </el-form-item>
                                </el-col>
                            </transition>
                        ...
                        <el-col :span="24" style="display: flex; flex-wrap: wrap;">
                            <transition name="el-fade-in-linear">
                                <el-col :span="10" v-show="mirror" class="transition-box">
                                    <el-form-item label="种类" prop="zhong">
                                        <el-radio-group v-model="zhong" style="margin-bottom: 20px;" class="button-box">
                                            <el-radio-button :label="true">单门</el-radio-button>
                                            <el-radio-button :label="false">双门</el-radio-button>
                                            <el-radio-button>内置照明</el-radio-button>
                                        </el-radio-group>
                                    </el-form-item>
                                </el-col>
                            </transition>
        ...
        <el-row :span="24" style="height: 410px;display: flex;justify-content: space-between;margin-top: 60px">
            <el-col :span="12" style="position: relative;cursor: pointer" class="img-box">
                <img src="../../../assets/list/t1.png" alt="">
                <div class="xiaoyao-box">
                    <el-row class="gang-box"></el-row>
                    <el-row class="mahouse-box">MAHOUSE</el-row>
                    <el-row class="ws-box">午睡逍遥椅</el-row>
                    <el-row class="give-box">Give you a truly relaxing</el-row>
                    <el-row class="and-box">and comfortable experience.</el-row>
                    <el-row class="jg-box">
                        <el-col>1029.00</el-col>
                        <el-col class="rmb-box">RMB</el-col>
                    </el-row>
                    <el-row class="btn-box">
                        <el-button style="background-color: #5ed5e0;border: 1px solid #5ed5e0!important;color: white;padding: 10px 20px">GO</el-button>
                    </el-row>
                </div>
            </el-col>
            <!--            第二个图-->
...
<style scoped>
    ...
    .img-box{
        background: url("../../../assets/list/GreiberWhite.png");
        background-size: 100% 100%;
    }
    .img-box img{
        width: 410px;
    ...
    .yz-box{
        margin: 0 auto;
        height: 254px;
        background: url("../../../assets/list/t2.png") no-repeat;
        background-position: center center;
    }
    .bun-box{
        height: calc(410px - 254px);
    }
    .g-box{
        width: 22px;
        height: 4px;
    ...
    .ying-box:hover .gg-box,.ying-box:hover .gwc-box,.ying-box:hover .yc-box{
        display: block;
    }
    .h-box img{
        position: absolute;
    ...
    .bj-box{
        height: 184px;
        background: url("../../../assets/list/bj7.png") no-repeat;
        background-size: cover;
        position: absolute;
        top:50px;
    ...
    .ye-box{
        height: 80px;
        background-color: rgba(255,220,146,.8);
        position: absolute;
        z-index: 20;
        left: 0;
        right: 0;
    ...
    .yz-box1{
        background: url("../../../assets/list/t3.png") no-repeat;
        background-position: center center;
    }
    .yz-box4{
        background: url("../../../assets/list/t4.png") no-repeat;
        background-position: center center;
    }
    .yz-box5{
        background: url("../../../assets/list/t5.png") no-repeat;
        background-position: center center;
    }
    .yz-box6{
        background: url("../../../assets/list/t6.png") no-repeat;
        background-position: center center;
    }
    .yz-box7{
        background: url("../../../assets/list/t7.png") no-repeat;
        background-position: center center;
    }
    .yz-box8{
        background: url("../../../assets/list/t8.png") no-repeat;
        background-position: center center;
    }
    .yz-box9{
        background: url("../../../assets/list/t9.png") no-repeat;
        background-position: center center;
    }
    .yz-box11{
        background: url("../../../assets/list/t11.png") no-repeat;
        background-position: center center;
    }
    .yz-box12{
        background: url("../../../assets/list/t12.png") no-repeat;
        background-position: center center;
    }
    .yz-box13{
        background: url("../../../assets/list/t13.png") no-repeat;
        background-position: center center;
    }
    .yz-box14{
        background: url("../../../assets/list/t14.png") no-repeat;
        background-position: center center;
    }
    .yz-box15{
